...
//
//public class StockDrink extends JPanel {
//
...
//            String query = "INSERT INTO drinkstock (pro_id, pro_name, pro_price, pro_qty, pro_category, img) VALUES (?, ?, ?, ?, ?, ?)";
...
//        String query = "SELECT COUNT(*) FROM drinkstock WHERE pro_id = ?";
//        try (PreparedStatement pstmt = cn.prepareStatement(query)) {
//            pstmt.setInt(1, id);
...
//            String query = "SELECT * FROM drinkstock WHERE pro_id = ?";
...
//        String query = "SELECT * FROM drinkstock ORDER BY pro_id"; // Ensure table name is correct
...
//        String deleteQuery = "DELETE FROM drinkstock WHERE pro_id = ?"; 
//        String selectQuery = "SELECT * FROM drinkstock"; 
//
...
//            String selectProductQuery = "SELECT * FROM drinkstock WHERE pro_id = ?";
...
//        String updateQuery = "UPDATE drinkstock SET pro_id = ? WHERE pro_id = ?";
//        String selectQuery = "SELECT * FROM drinkstock"; 
//
...
//        String updateQuery = "UPDATE drinkstock SET pro_name = ? WHERE pro_id = ? AND pro_name = ?";
//        String selectQuery = "SELECT * FROM drinkstock";
//
//        try (PreparedStatement updatePstmt = cn.prepareStatement(updateQuery); PreparedStatement selectPstmt = cn.prepareStatement(selectQuery)) {
//
...
//        String updateQuery = "UPDATE drinkstock SET pro_price = ? WHERE pro_id = ? AND pro_price = ?";
//        String selectQuery = "SELECT * FROM drinkstock"; // Ensure table name is correct
//
...
//        // Ensure the table name is correct
//        String updateQuery = "UPDATE drinkstock SET pro_category = ? WHERE pro_id = ? AND pro_category = ?";
//        String selectQuery = "SELECT * FROM drinkstock"; // Ensure table name is correct
//
//        try (PreparedStatement updatePstmt = cn.prepareStatement(updateQuery); // Use 'cn' for the connection
//                 PreparedStatement selectPstmt = cn.prepareStatement(selectQuery)) {
...
//        String insertQuery = "INSERT INTO drinkstock (pro_id, pro_name, pro_price, pro_qty, pro_category, img) VALUES (?, ?, ?, ?, ?, ?)";
//        String selectQuery = "SELECT * FROM drinkstock WHERE pro_id = ?";
//
...
//                String checkQuery = "SELECT COUNT(*) FROM drinkstock WHERE pro_id = ?";
...
//            String selectQuery = "SELECT pro_id FROM drinkstock WHERE pro_id = ?";
...
//                    String updateQuery = "UPDATE drinkstock SET img = ? WHERE pro_id = ?";
