...
//
//public class StockHealthAndBeauty extends JPanel {
//
...
//
//        // Prepare SQL query for insertion  healthandbeauty
//        String query = "INSERT INTO healthandbeauty (pro_id, pro_name, pro_price, pro_qty, pro_category, img) VALUES (?, ?, ?, ?, ?, ?)";
...
//    String query = "SELECT COUNT(*) FROM healthandbeauty WHERE pro_id = ?";
//    try (PreparedStatement pstmt = cn.prepareStatement(query)) {
//        pstmt.setInt(1, id);
...
//        String query = "SELECT * FROM healthandbeauty";
//
...
//            String query = "SELECT * FROM healthandbeauty WHERE pro_id = ?";
...
//        String query = "SELECT * FROM healthandbeauty ORDER BY pro_id"; // Ensure table name is correct
...
//        String deleteQuery = "DELETE FROM healthandbeauty WHERE pro_id = ?"; // Ensure table name is correct
//        String selectQuery = "SELECT * FROM healthandbeauty"; // Ensure table name is correct
//
...
//            String selectProductQuery = "SELECT * FROM healthandbeauty WHERE pro_id = ?";
...
//        String updateQuery = "UPDATE healthandbeauty SET pro_id = ? WHERE pro_id = ?"; // Ensure table name is correct
//        String selectQuery = "SELECT * FROM healthandbeauty"; // Ensure table name is correct
//
...
//        String updateQuery = "UPDATE healthandbeauty SET pro_name = ? WHERE pro_id = ? AND pro_name = ?";
//        String selectQuery = "SELECT * FROM healthandbeauty";
//
//        try (PreparedStatement updatePstmt = cn.prepareStatement(updateQuery); PreparedStatement selectPstmt = cn.prepareStatement(selectQuery)) {
//
...
//        String updateQuery = "UPDATE healthandbeauty SET pro_price = ? WHERE pro_id = ? AND pro_price = ?";
//        String selectQuery = "SELECT * FROM healthandbeauty"; // Ensure table name is correct
//
...
//        // Ensure the table name is correct
//        String updateQuery = "UPDATE healthandbeauty SET pro_category = ? WHERE pro_id = ? AND pro_category = ?";
//        String selectQuery = "SELECT * FROM healthandbeauty"; // Ensure table name is correct
//
//        try (PreparedStatement updatePstmt = cn.prepareStatement(updateQuery); // Use 'cn' for the connection
//                 PreparedStatement selectPstmt = cn.prepareStatement(selectQuery)) {
...
//        String insertQuery = "INSERT INTO healthandbeauty (pro_id, pro_name, pro_price, pro_qty, pro_category, img) VALUES (?, ?, ?, ?, ?, ?)";
//        String selectQuery = "SELECT * FROM healthandbeauty WHERE pro_id = ?";
//
...
//                String checkQuery = "SELECT COUNT(*) FROM healthandbeauty WHERE pro_id = ?";
...
//        String updateQuery = "UPDATE healthandbeauty SET pro_qty = ? WHERE pro_id = ?";
//        String selectQuery = "SELECT * FROM healthandbeauty"; // Ensure table name is correct
//
//        try (PreparedStatement updatePstmt = cn.prepareStatement(updateQuery); PreparedStatement selectPstmt = cn.prepareStatement(selectQuery)) {
//
...
//            String selectQuery = "SELECT pro_id FROM healthandbeauty WHERE pro_id = ?";
...
//                    String updateQuery = "UPDATE healthandbeauty SET img = ? WHERE pro_id = ?";
